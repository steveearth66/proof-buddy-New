...
ARITHMETIC = ["+","*","-","=",">","<"] # special math characters. any other math uses ascii, such as expt, quotient, remainder. Note: "/" not permitted
...
class Node:
    ...
    def __eq__(self, other):
        if other == None:
            return False #this is just in case someone made a parameter called "None", we don't want that equating to None.
        return str(self) == str(other)
