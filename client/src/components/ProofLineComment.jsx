...
const ProofLineComment = ({
            ...
            const handleSubmit = async () => {
                          ...
                          try {
                                          ...
                                          // Clear draft and save timestamp
                            try {
                          ...
                          <span style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                                    {/* Toggle button */}
                                          <button
                                                    ...
                                                    {hasDraft && (
                                                                              <span
                                                                                                    style={{ color: '#e65c00', fontSize: '0.65rem', fontWeight: 700, marginLeft: '1px' }}
                                                                                                    title="Unsaved draft"
                                                                                                  >*</span>span>
                                                  )}
                                          </button>button>
                                ...
                                <Modal
                                        ...
                                        <Modal.Body style={{ padding: '20px 24px' }}>
                                                                                                    ...
                                                                                                    <div>
                                                                                                              ...
                                                                                                              {isInstructor ? (
                                                                                                                                    ...
                                                                                                                                    <div style={{
                                                                                                                                                            ...
                                                                                                                                                            <button
                                                                                                                                                                                                onClick={() => handleCopy(instructorComment, 'instructor')}
                                                                                                                                                                                                style={{
                                                                                                                                                                                                                                      background: 'none',
                                                                                                                                                                                                                                      border: 'none',
                                                                                                                                                                                                                                      cursor: 'pointer',
                                                                                                                                                                                                                                      fontSize: '0.75rem',
                                                                                                                                                                                                                                      color: copySuccess === 'instructor' ? '#198754' : '#6c757d',
                                                                                                                                                                                                                                      flexShrink: 0,
                                                                                                                                                                                                                                      padding: '0 2px'
                                                                                                                                                                                                                                                                          }}
                                                                                                                                                                                                title="Copy to clipboard"
                                                                                                                                                                                              >
                                                                                                                                                                      {copySuccess === 'instructor' ? '\u2713' : '\uD83D\uDCCB'}
                                                                                                                                                                      </button>button>
                                                                                                                                              </div>div>
                                                                                                                        )}
                                                                                                              </div>div>
                                                                                                    ...
                                                                                                    <div>
                                                                                                                        ...
                                                                                                                        <div style={{
                                                                                                                                    ...
                                                                                                                                    gap: '4px'
                                                                                                                                              ...
                                                                                                                                              <button
                                                                                                                                                                                onClick={() => handleCopy(studentComment, 'student')}
                                                                                                                                                                                style={{
                                                                                                                                                                                                                    background: 'none',
                                                                                                                                                                                                                    border: 'none',
                                                                                                                                                                                                                    cursor: 'pointer',
                                                                                                                                                                                                                    fontSize: '0.75rem',
                                                                                                                                                                                                                    color: copySuccess === 'student' ? '#198754' : '#6c757d',
                                                                                                                                                                                                                    flexShrink: 0,
                                                                                                                                                                                                                    padding: '0 2px'
                                                                                                                                                                                                                                                      }}
                                                                                                                                                                                title="Copy to clipboard"
                                                  ...
                                                  {/* Feedback messages */}
                                                  {saveSuccess && (
                                                                      <div style={{ color: '#198754', fontSize: '0.82rem', marginTop: '6px', fontWeight: 500 }}>
                                                                                    \u2713 Comment saved successfully
                                                                      </div>div>
                                                  )}
                                                  {saveError && (
                                                                      <div style={{ color: '#dc3545', fontSize: '0.82rem', marginTop: '6px' }}>
                                                                                {saveError}
                                                                      </div>div>
                                                  )}
