# Start Django backend, React frontend, and run automated test scenario

Write-Host "Starting Proof Buddy development servers with automated trial..." -ForegroundColor Green
...
Write-Host "`nWaiting briefly for servers to start..." -ForegroundColor Yellow
Start-Sleep -Seconds 8

Write-Host "Launching automated trial..." -ForegroundColor Green

# Run the Puppeteer automation script
Write-Host "Running trial-automation.js..." -ForegroundColor Cyan
node trial-automation.js
...
Write-Host "`nServers are still running. Close the PowerShell windows to stop them." -ForegroundColor Gray
