from expression_tree.Decorator import makePosDict
...
def apply_rule(request):
    ...
    jsonTree = makePosDict(ERProofLine(json_data["currentRacket"]).exprTree)
...
def check_goal(request):
    ...
    jsonTree = makePosDict(ERProofLine(json_data["goal"]).exprTree)
    proof = get_or_set_proof(user)
